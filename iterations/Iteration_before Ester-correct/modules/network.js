...
//Fetch for search
  export async function fetchMovieSearched() {
    try {
  ...
  const response = fetch(`https://api.themoviedb.org/3/search/movie?query=${userInput}include_adult=false&language=en-US&page=1`, options)
